...
TOOLBAR_ITEMS = \
  [
    ...
    'type': 'tally',
    'func': lambda d: \
        d.core is not None and d.core.tally.IsValid() and d.core.tally.nz > 1
    },
    {
    ...
    'type': '',
    'func': lambda d: d.core is not None and \
	d.core.npinx > 0 and d.core.npiny > 0
    },
#    {
